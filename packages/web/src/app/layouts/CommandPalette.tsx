...
export function CommandPalette({ open, onOpenChange }: CommandPaletteProps) {
  ...
  const commands: CommandItem[] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        icon: FileText,
        action: () => navigate("/documents?new=1"),
        group: "Actions",
      },
      {
        id: "start-workshop",
        ...
        icon: Users,
        action: () => navigate("/workshops?new=1"),
        group: "Actions",
      },
      {
        id: "ask-ai",
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      {/* Command Dialog */}
      <div className="fixed inset-4 md:inset-auto md:left-1/2 md:top-[20%] md:-translate-x-1/2 md:w-full md:max-w-lg animate-slide-down flex flex-col">
        <Command
          className={cn(
